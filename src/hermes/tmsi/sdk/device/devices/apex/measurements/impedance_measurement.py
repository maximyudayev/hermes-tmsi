...
class ImpedanceMeasurement(TMSiMeasurement):
    ...
    def _sampling_function(self):
        TMSiLoggerActivity().log(
            "Sampling Thread->>APEX-SDK: GET impedance samples request"
        )
        ...
        TMSiLoggerActivity().log(
            "APEX-SDK->>Sampling Thread: GET impedance samples response"
        )
    ...
    def start(self):
        ...
        TMSiLoggerActivity().log(
            "{}->>APEX-SDK: set device impedance request ON".format(self.get_name())
        )
    ...
    def stop(self):
        ...
        TMSiLoggerActivity().log(
            "{}->>APEX-SDK: set device impedance request OFF".format(self.get_name())
        )
        self._dev.set_device_impedance_request(measurement_request)
